...
<html lang="en">
	<head>
		...
		<!--IMPORTANT assets/plugins/icheck/all.css must be at the top of this list!-->
		<link rel='stylesheet' type='text/css' href='assets/plugins/icheck/all.css'/>
		<link rel="stylesheet" href="css/dc.css"/>
		<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
		<link rel="stylesheet" href="assets/plugins/smDateTimeRangePicker/src/picker.css"/>
		<link rel="stylesheet" href="bower_components/seiyria-bootstrap-slider/dist/css/bootstrap-slider.min.css"/>
		<link rel="stylesheet" href="bower_components/angular-bootstrap-toggle-switch/style/default/angular-toggle-switch.css"/>
		...
		<link rel="stylesheet" type='text/css' href="assets/plugins/ng-tags-input/ng-tags-input.css"/>
        <link rel="stylesheet" type='text/css' href="assets/plugins/ng-tags-input/ng-tags-input.bootstrap.css"/>
        <link rel="stylesheet" type='text/css' href="assets/plugins/floatingScroll/floating-scroll.css"/>
		...
		<link rel='stylesheet' type='text/css' href='assets/plugins/angular-sticky-table-header/angular-sticky-table-header.css'/>
		<link rel='stylesheet' type='text/css' href="assets/widget_embed_191_ours.css"/>
		<link rel="stylesheet" type="text/css" href="assets/css/compiled_styles.css" />
		<link rel="stylesheet" type="text/css" href="assets/css/styles.css" />
		<link rel="stylesheet" href="bower_components/mediaelement/build/mediaelementplayer.min.css" />
		<link rel="stylesheet" type="text/css" href="assets/css/videogular.css" />
		<!-- endbuild -->
	...
	<body class=""
		  ...
		  ng-cloak
		  ng-style="!showHeaderOnVanity && {'padding-top': '0px'}">
...
<!-- End Google Tag Manager -->
		<header ng-show="showHeaderOnVanity" class="navbar navbar-inverse" ng-class="{'navbar-fixed-top': style_fixedHeader, 'navbar-static-top': !style_fixedHeader}" role="banner">
...
-->
		...
		<!--TODO This might be unnecessary since we already have angular-ui-select2, I didn't notice any problems
		 with the select drop downs that are using the select2 directive-->
		...
		<script src="js/angular-sticky-table-header2.js"></script>
		<script src="js/angular-sticky-table-header3.js"></script>
		...
		<script src="bower_components/watch-dom/dist/watch-dom.js"></script>
		...
		<!-- end video -->
		<script src="assets/plugins/ng-tags-input/ng-tags-input.js"></script>
		<script src="assets/plugins/floatingScroll/floating-scroll.js"></script>
		


		<script type='text/javascript' src='assets/plugins/form-multiselect/js/jquery.multi-select.js'></script>
		...
		<!-- build:js js/vendor2.js -->
		<script type='text/javascript' src='assets/plugins/bootstro.js/bootstro.min.js'></script>
		<script type='text/javascript' src='assets/plugins/ngInfiniteScroll-1.0.0/build/ng-infinite-scroll.min.js'></script>
		<!-- <script type='text/javascript' src='js/jquery-deparam.min.js'></script> -->
		<script src="bower_components/moment/moment.js"></script>
		<script src="assets/plugins/moment-timezone/moment-timezone-with-data.js"></script>
		<!--<script src="bower_components/moment-timezone/moment-timezone.js"></script>-->
		<script src="assets/plugins/smDateTimeRangePicker/src/picker.js"></script>
		...
		<script type="text/javascript" src="assets/plugins/angular-multiselect/angularjs-dropdown-multiselect-v2.js"></script>
		<script type="text/javascript" src="assets/plugins/angular-multiselect/angularjs-dropdown-multiselect-v3.js"></script>
		<script type="text/javascript" src="assets/plugins/angular-multiselect/angularjs-dropdown-multiselect-v4.js"></script>
        ...
        <!-- New audio play for listen calls -->
		...
		<!-- build:js  js/app.js-->
		<script src="scripts/chart/CallFlows.js"></script>
		<script src="scripts/breadcrumb/breadcrumb.js"></script>
		<script src="scripts/factory/logout.js"></script>
		...
		<script src="scripts/services/daterangeselected.js"></script>
		<script src="scripts/services/numberFormat.js"></script>
		<script src="scripts/supportadmin/supportadmin.js"></script>
		<script src="scripts/services/apiparam.js"></script>
		<script src="scripts/services/scheldue_url_formatter.js"></script>
		<script src="scripts/services/filter_helper.js"></script>
		<script src="scripts/services/reportparam.js"></script>
		<script src="scripts/table/Editable.js"></script>
		<script src="scripts/chart/Flot.js"></script>

		<!--Looks like a demo script-->
		<script src="scripts/chart/Inline.js"></script>
		<script src="scripts/login/Controllers.js"></script>
		<script src="scripts/vanity_number/vanitynumber.js"></script>
		...
		<script src="scripts/cfa_reports/cfareports.js"></script>

		<script src="scripts/report/call_flow.js"></script>
		<script src="scripts/report/call_flow_settings.js"></script>
		<script src="scripts/report/group_activity.js"></script>
		<script src="scripts/report/campaign_list.js"></script>
		<script src="scripts/report/directives.js"></script>

		<script src="scripts/calldetails/callsdetails.js"></script>
		<script src="scripts/conversations/smsconversations.js"></script>
		<script src="scripts/scorecards/scorecards.js"></script>
		<script src="scripts/selectScore/select_score.js"></script>
		<script src="scripts/calloverview/calloverview.js"></script>
		<script src="scripts/controllers/cfcontroller.js"></script>
		<script src="scripts/org_unit/org_unit.js"></script>
		<script src="scripts/org_unit/old_org_unit.js"></script>

		<script src="scripts/subscriptions/subscriptions.js"></script>
		<script src="scripts/ui-components/Modals.js"></script>
		<script src="scripts/report/dashboard.js"></script>
		<script src="scripts/support/support.js"></script>
		<script src="scripts/app.js"></script>
		<script src="scripts/services/timehelper.js"></script>
		<script src="scripts/services/date_time_timezoned.js"></script>
		<script src="js/crossfilter.js"></script>
		<script src="js/barchart.js"></script>
		<script type="text/javascript" src="assets/plugins/form-colorpicker/js/bootstrap-colorpicker.js"></script>
		<script src="scripts/controllers/ColorPicker.js"></script>
		<script src="scripts/form/directives/font-selector.js"></script>
    <script src="scripts/form/directives/hexcode.js"></script>
    <script src="scripts/whitelabel/WhitelabelColorsLogoCtrl.js"></script>
    <script src="scripts/whitelabel/WhiteLabelCSSService.js"></script>
    <script src="scripts/whitelabel/WhiteLabelWebService.js"></script>
    <script src="scripts/whitelabel/WhitelabelEmailsCtrl.js"></script>
    <script src="scripts/factory/DynamicCssInsertion.js"></script>
    <script src="scripts/report/call_flow_settings_webservices.js"></script>
    <script src="scripts/report/group_activity_webservices.js"></script>
     <script src="scripts/report/campaign_list_webservice.js"></script>
		<script src="scripts/sandbox/sandboxCtrl.js"></script>
		<script src="scripts/report/advFilSrvc.js"></script>

		<script src="scripts/campaign/campaign.js"></script>
		<script src="scripts/campaign/old-campaign.js"></script>
		<script src="scripts/user/user.js"></script>
		<script src="scripts/dni/dni.js"></script>
		<script src="scripts/georoute/georoute.js"></script>
		<script src="scripts/georoute/old-georoute.js"></script>
		<script src="scripts/tag/tag.js"></script>
		<script src="scripts/activity/stream.js"></script>
		<script src="scripts/webhook/webhooks.js"></script>
		<script src="scripts/caller_privacy/caller_privacy.js"></script>
		<script src="scripts/dataappend/dataappend.js"></script>
		<script src="scripts/subscriptions/subscriptions.js"></script>
		<script src="scripts/form/FileUploads.js"></script>
		<script src="scripts/dni/dni.js"></script>
		<script src="scripts/distribution_list/distribution_list.js"></script>
		<script src="scripts/distribution_list/distribution_list_webservice.js"></script>
		<script src="scripts/integration/doubleclick.js"></script>
		<script src="scripts/integration/googleanalytics.js"></script>
		<script src="scripts/ui-elements/Tables.js"></script>
		<script src="scripts/scheduledreport/scheduledreports.js"></script>
		<script src="scripts/scheduledplans/scheduledplans.js"></script>
		<script src="scripts/scheduledreport/scheduledreports_webservice.js"></script>
		<script src="scripts/blacklist/blacklist.js"></script>
		<!-- endbuild -->
		...
		<script src="bower_components/angular-static-include/includeStatic.js"></script>
		<script type='text/javascript' src='assets/plugins/customStickyHeader.js'></script>
		...
		<script src="lib/customJsPdf.js"></script>
		<script src="bower_components/html2pdf.js/dist/html2pdf.min.js"></script>
		<script src="bower_components/html2pdf.js/dist/html2pdf.bundle.min.js"></script>
		<script src="assets/plugins/kendo/kendo.all.min.js"></script>
		<!--endbuild-->
