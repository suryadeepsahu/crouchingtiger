...
angular
	...
	.directive('flotChart', function () {
		...
		return {
			...
			link: function (scope, element, attr) {
				...
				// If chart gets defined first with undefined value (most likely happening from
				// getting compiled BEFORE external data is retrieved) then it doesnt get
				// rerendered from bound scope data values below, even though it's watching it
				// It WILL, update OK (with bad styling), however, if it was AT LEAST defined to something
				// such as {} or []
				// but for best results just don't create it at all until you have real data for it
  ...
  //
  //  $scope.pieData = [
  //      { label: "Answered",  data: 510},
  //      { label: "Unanswered",  data: 130}
